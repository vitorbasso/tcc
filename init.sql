...
create table if not exists `wallet`(
    ...
    `monthly_balance_daytrade` decimal(20,2),
    `monthly_balance` decimal(20,2),
    `lifetime_balance_daytrade` decimal(20,2),
    `lifetime_balance` decimal(20,2),
...
create table if not exists `asset`(
    ...
    `average_quantity_count` int not null,
    `average_value_count` decimal(20,2) not null,
    `date_created` timestamp not null,
    `date_updated` timestamp,
    primary key (`id`),
