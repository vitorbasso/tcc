...
--changeset vitor:1589297069592-1
CREATE TABLE client (
...
--changeset vitor:1589297069592-2
CREATE TABLE stock (
...
--changeset vitor:1589297069592-3
...
--changeset vitor:1589297069592-4
CREATE TABLE user (
    email VARCHAR(255) NOT NULL,
...
--changeset vitor:1589297069592-5
CREATE TABLE wallet (
    id BIGINT NOT NULL,
    name VARCHAR(255) NULL,
...
--changeset vitor:1589297069592-10
ALTER TABLE stock_assets
...
--changeset vitor:1589297069592-11
ALTER TABLE user
ADD CONSTRAINT user_ibfk_1 FOREIGN KEY (email) REFERENCES client (email)
ON UPDATE RESTRICT ON DELETE RESTRICT;
--rollback ALTER TABLE user DROP FOREIGN KEY user_ibfk_1;

--changeset vitor:1589297069592-12
ALTER TABLE wallet
