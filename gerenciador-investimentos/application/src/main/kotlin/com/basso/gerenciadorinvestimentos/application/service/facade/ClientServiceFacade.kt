...
internal class ClientServiceFacade(
    ...
    override fun updateClient(cpf: String, clientUpdateRequest: ClientUpdateRequest)
            = this.clientService.updateClient(this.getClient(cpf), clientUpdateRequest)

    override fun deleteClient(cpf: String) = this.clientService.deleteClient(this.clientService.getClient(cpf))
}