...
--changeset vitor:1596404080849-1
...
--changeset vitor:1596404080849-2
...
--changeset vitor:1596404080849-3
CREATE TABLE stock (ticker VARCHAR(6) NOT NULL, current_value DECIMAL(20, 2) NOT NULL, closing_value DECIMAL(20, 2) NULL, opening_value DECIMAL(20, 2) NULL, highest_value DECIMAL(20, 2) NULL, lowest_value DECIMAL(20, 2) NULL, variation DECIMAL(20, 4) NULL, market_value DECIMAL(20, 2) NULL, daily_volume BIGINT NULL, paper_in_circulation BIGINT NULL, CONSTRAINT PK_STOCK PRIMARY KEY (ticker));

--changeset vitor:1596404080849-4
CREATE TABLE transaction (id BIGINT AUTO_INCREMENT NOT NULL, type VARCHAR(3) NOT NULL, quantity INT NULL, value DECIMAL(13, 2) NULL, stock_ticker VARCHAR(6) NOT NULL, asset_id BIGINT NOT NULL, date_created timestamp DEFAULT NOW() NOT NULL, date_updated timestamp DEFAULT '0000-00-00 00:00:00' NOT NULL, CONSTRAINT PK_TRANSACTION PRIMARY KEY (id));

--changeset vitor:1596404080849-5
...
--changeset vitor:1596404080849-6
CREATE INDEX asset_id ON transaction(asset_id);

--changeset vitor:1596404080849-7
CREATE INDEX client_id ON wallet(client_id);

--changeset vitor:1596404080849-8
CREATE INDEX stock_ticker ON asset(stock_ticker);

--changeset vitor:1596404080849-9
CREATE INDEX stock_ticker ON transaction(stock_ticker);

--changeset vitor:1596404080849-10
CREATE INDEX wallet_id ON asset(wallet_id);

--changeset vitor:1596404080849-11
...
--changeset vitor:1596404080849-12
...
--changeset vitor:1596404080849-13
ALTER TABLE transaction ADD CONSTRAINT transaction_ibfk_1 FOREIGN KEY (stock_ticker) REFERENCES stock (ticker) ON UPDATE NO ACTION ON DELETE NO ACTION;

--changeset vitor:1596404080849-14
...
--changeset vitor:1596404080849-15
