...
-- changeset vitor:1613858527644-1
...
-- changeset vitor:1613858527644-2
...
-- changeset vitor:1613858527644-3
CREATE TABLE monthly_wallet (id BIGINT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, broker VARCHAR(255) NOT NULL, balance_daytrade DECIMAL(20, 2) DEFAULT 0.00 NULL, balance DECIMAL(20, 2) DEFAULT 0.00 NULL, withdrawn DECIMAL(20, 2) DEFAULT 0.00 NULL, withdrawn_daytrade DECIMAL(20, 2) DEFAULT 0.00 NULL, tax_deducted DECIMAL(20, 2) DEFAULT 0.00 NULL, wallet_id BIGINT NOT NULL, wallet_month date NOT NULL, client_id BIGINT NOT NULL, date_created timestamp DEFAULT NOW() NOT NULL, date_updated timestamp DEFAULT NOW() NOT NULL, CONSTRAINT PK_MONTHLY_WALLET PRIMARY KEY (id));

-- changeset vitor:1613858527644-4
...
-- changeset vitor:1613858527644-5
...
-- changeset vitor:1613858527644-6
CREATE TABLE wallet (id BIGINT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, broker VARCHAR(255) NOT NULL, balance_daytrade DECIMAL(20, 2) DEFAULT 0.00 NULL, balance DECIMAL(20, 2) DEFAULT 0.00 NULL, withdrawn DECIMAL(20, 2) DEFAULT 0.00 NULL, withdrawn_daytrade DECIMAL(20, 2) DEFAULT 0.00 NULL, tax_deducted DECIMAL(20, 2) DEFAULT 0.00 NULL, wallet_month date NOT NULL, client_id BIGINT NOT NULL, date_created timestamp DEFAULT NOW() NOT NULL, date_updated timestamp DEFAULT NOW() NOT NULL, CONSTRAINT PK_WALLET PRIMARY KEY (id));

-- changeset vitor:1613858527644-7
CREATE INDEX asset_id ON transaction(asset_id);

-- changeset vitor:1613858527644-8
CREATE INDEX client_id ON monthly_wallet(client_id);

-- changeset vitor:1613858527644-9
CREATE INDEX client_id ON wallet(client_id);

-- changeset vitor:1613858527644-10
CREATE INDEX stock_ticker ON asset(stock_ticker);

-- changeset vitor:1613858527644-11
CREATE INDEX transaction_date ON transaction(transaction_date);

-- changeset vitor:1613858527644-12
CREATE INDEX wallet_id ON asset(wallet_id);

-- changeset vitor:1613858527644-13
...
-- changeset vitor:1613858527644-14
...
-- changeset vitor:1613858527644-15
...
-- changeset vitor:1613858527644-16
...
-- changeset vitor:1613858527644-17
