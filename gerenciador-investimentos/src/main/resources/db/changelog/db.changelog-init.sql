...
--changeset vitor:1596409283328-1
...
--changeset vitor:1596409283328-2
...
--changeset vitor:1596409283328-3
CREATE TABLE stock (ticker VARCHAR(25) NOT NULL, current_value DECIMAL(20, 2) NULL, closing_value DECIMAL(20, 2) NULL, opening_value DECIMAL(20, 2) NULL, highest_value DECIMAL(20, 2) NULL, lowest_value DECIMAL(20, 2) NULL, variation DECIMAL(20, 4) NULL, market_value DECIMAL(20, 2) NULL, daily_volume BIGINT NULL, paper_in_circulation BIGINT NULL, CONSTRAINT PK_STOCK PRIMARY KEY (ticker));

--changeset vitor:1596409283328-4
...
--changeset vitor:1596409283328-5
...
--changeset vitor:1596409283328-12
...
--changeset vitor:1596409283328-13
...
--changeset vitor:1596409283328-14
...
--changeset vitor:1596409283328-15
