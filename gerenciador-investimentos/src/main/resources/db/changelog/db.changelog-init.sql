...
-- changeset vitor:1609727963905-1
...
-- changeset vitor:1609727963905-2
...
-- changeset vitor:1609727963905-3
...
-- changeset vitor:1609727963905-4
...
-- changeset vitor:1609727963905-5
CREATE TABLE transaction (id BIGINT AUTO_INCREMENT NOT NULL, type INT NOT NULL, quantity INT DEFAULT 0 NULL, value DECIMAL(13, 2) DEFAULT 0.00 NULL, transaction_date date NOT NULL, is_sellout TINYINT(1) DEFAULT 0 NOT NULL, daytrade TINYINT(1) DEFAULT 0 NOT NULL, daytrade_quantity INT DEFAULT 0 NOT NULL, asset_id BIGINT NOT NULL, date_created timestamp DEFAULT NOW() NOT NULL, date_updated timestamp DEFAULT NOW() NOT NULL, CONSTRAINT PK_TRANSACTION PRIMARY KEY (id));

-- changeset vitor:1609727963905-6
...
-- changeset vitor:1609727963905-13
...
-- changeset vitor:1609727963905-14
...
-- changeset vitor:1609727963905-15
...
-- changeset vitor:1609727963905-16
