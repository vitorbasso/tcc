...
-- changeset vitor:1624832788266-1
CREATE TABLE asset (id BIGINT AUTO_INCREMENT NOT NULL, wallet_id BIGINT NOT NULL, stock_ticker VARCHAR(6) NOT NULL, average_cost DECIMAL(13, 2) DEFAULT 0.00 NOT NULL, amount INT DEFAULT 0 NOT NULL, balance DECIMAL(20, 2) DEFAULT 0.00 NOT NULL, daytrade_balance DECIMAL(20, 2) DEFAULT 0.00 NOT NULL, withdrawn DECIMAL(20, 2) DEFAULT 0.00 NULL, withdrawn_daytrade DECIMAL(20, 2) DEFAULT 0.00 NULL, date_created timestamp DEFAULT NOW() NOT NULL, date_updated timestamp DEFAULT NOW() NOT NULL, CONSTRAINT PK_ASSET PRIMARY KEY (id));

-- changeset vitor:1624832788266-2
...
-- changeset vitor:1624832788266-3
...
-- changeset vitor:1624832788266-4
...
-- changeset vitor:1624832788266-5
...
-- changeset vitor:1624832788266-6
...
-- changeset vitor:1624832788266-15
...
-- changeset vitor:1624832788266-16
...
-- changeset vitor:1624832788266-17
...
-- changeset vitor:1624832788266-18
