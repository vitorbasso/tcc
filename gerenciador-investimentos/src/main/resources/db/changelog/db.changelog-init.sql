...
-- changeset vitor:1611439809882-1
...
-- changeset vitor:1611439809882-2
...
-- changeset vitor:1611439809882-3
CREATE TABLE monthly_wallet (id BIGINT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, broker VARCHAR(255) NOT NULL, monthly_balance_daytrade DECIMAL(20, 2) DEFAULT 0.00 NULL, monthly_balance DECIMAL(20, 2) DEFAULT 0.00 NULL, withdrawn DECIMAL(20, 2) DEFAULT 0.00 NULL, withdrawn_daytrade DECIMAL(20, 2) DEFAULT 0.00 NULL, wallet_id BIGINT NOT NULL, wallet_month date NOT NULL, client_id BIGINT NOT NULL, date_created timestamp DEFAULT NOW() NOT NULL, date_updated timestamp DEFAULT NOW() NOT NULL, CONSTRAINT PK_MONTHLY_WALLET PRIMARY KEY (id));

-- changeset vitor:1611439809882-4
...
-- changeset vitor:1611439809882-5
CREATE TABLE transaction (id BIGINT AUTO_INCREMENT NOT NULL, type INT NOT NULL, quantity INT DEFAULT 0 NULL, value DECIMAL(13, 2) DEFAULT 0.00 NULL, transaction_date timestamp DEFAULT NOW() NOT NULL, is_sellout TINYINT(1) DEFAULT 0 NOT NULL, checking_value DECIMAL(13, 2) DEFAULT 0.00 NULL, checking_quantity INT DEFAULT 0 NULL, daytrade TINYINT(1) DEFAULT 0 NOT NULL, daytrade_quantity INT DEFAULT 0 NOT NULL, asset_id BIGINT NOT NULL, date_created timestamp DEFAULT NOW() NOT NULL, date_updated timestamp DEFAULT NOW() NOT NULL, CONSTRAINT PK_TRANSACTION PRIMARY KEY (id));

-- changeset vitor:1611439809882-6
CREATE TABLE wallet (id BIGINT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, broker VARCHAR(255) NOT NULL, monthly_balance_daytrade DECIMAL(20, 2) DEFAULT 0.00 NULL, monthly_balance DECIMAL(20, 2) DEFAULT 0.00 NULL, lifetime_balance_daytrade DECIMAL(20, 2) DEFAULT 0.00 NULL, lifetime_balance DECIMAL(20, 2) DEFAULT 0.00 NULL, withdrawn DECIMAL(20, 2) DEFAULT 0.00 NULL, withdrawn_daytrade DECIMAL(20, 2) DEFAULT 0.00 NULL, wallet_month date NOT NULL, client_id BIGINT NOT NULL, date_created timestamp DEFAULT NOW() NOT NULL, date_updated timestamp DEFAULT NOW() NOT NULL, CONSTRAINT PK_WALLET PRIMARY KEY (id));

-- changeset vitor:1611439809882-7
CREATE INDEX asset_id ON transaction(asset_id);

-- changeset vitor:1611439809882-8
CREATE INDEX client_id ON monthly_wallet(client_id);

-- changeset vitor:1611439809882-9
CREATE INDEX client_id ON wallet(client_id);

-- changeset vitor:1611439809882-10
CREATE INDEX stock_ticker ON asset(stock_ticker);

-- changeset vitor:1611439809882-11
CREATE INDEX transaction_date ON transaction(transaction_date);

-- changeset vitor:1611439809882-12
CREATE INDEX wallet_id ON asset(wallet_id);

-- changeset vitor:1611439809882-13
...
-- changeset vitor:1611439809882-14
...
-- changeset vitor:1611439809882-15
...
-- changeset vitor:1611439809882-16
...
-- changeset vitor:1611439809882-17
